...
<html class=" -webkit- -webkit-"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
	function canLend(){
	    if($("#fx_canLend2").css("display")=='none'){
  
           $("#fx_canLend2").css("display","block");
		   document.getElementById("microbye_available").value = "1";
		}
		else{
		   $("#fx_canLend2").css("display","none");
		   document.getElementById("microbye_available").value = "0";
		}
...
<body>
    <div id="container" class="container body" style="min-height: 748px;">
		...
		<p style="word-wrap:break-word;">分享你认为有意义的好书！</p>
		</div>
			...
			<form id="form" action="http://hpweixin.microbye.com/index.php?s=/addon/Forms/Wap/index.html" method="post" class="form-horizontal p_10">
					...
					<div class="form-item cf">
						 ...
						 <div class="controls">	 
							 ...
							 <input  type="text" class="text input-large" name="book" placeholder="推荐书名" value=""> 	
					...
					<div class="form-item cf">
						 ...
						 <div class="controls">  
							 ...
							 <input type="text" class="text input-large" name="writer" placeholder="书目作者" value="">
					...
					<div class="form-item cf">
						 ...
						 <div class="controls">
						   <img src="<?php echo ADDON_PUBLIC_PATH;?>/css/form/1_12.gif">
							<textarea name="description" placeholder = "推荐理由"></textarea>
						 </div>
					</div>
					<div class="form-item cf">
						
						 <span class="fx_canLendText">我愿意出借本书</span>
						 <div class="fx_canLend" onclick="canLend()"></div>
						 <input type = "hidden" id = "microbye_available" name = "available" value = "0">
						 <div class="fx_canLend2" id="fx_canLend2"  onclick="canLend()"></div>
					</div>
...
$('#submit').click(function(){
  ...
  */
  if(mark==true){
   $.Dialog.loading();
   $.ajax({
	   url:"index.php?s=/addon/WeiSite/BookInfo/adviseDeal/token/gh_b5826b7a409f",
	   type:'post',
