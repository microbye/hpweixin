...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
                <form id="form" action="index.php?s=/addon/BookManage/BookManage/add" method="post" class="form-horizontal form-center">
					...
					<div class="form-item cf toggle-writer">
						...
						<div class="controls">
							<input type="text" class="text" name="writer" value="">                    
						</div>
					</div>                
					
					<div class="form-item cf toggle-avaliable">
						<label class="item-label">
                                        状态(1可借2不可借)                     
							<span class="check-tips">
                            </span>
					...
					<div class="form-item cf toggle-description">
						...
						<div class="controls">
							 ...
							 <input  type = text  height = "20"  name="description" value="">
