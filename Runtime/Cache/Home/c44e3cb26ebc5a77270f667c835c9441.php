...
<html class=" -webkit- -webkit-"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="<?php echo ADDON_PUBLIC_PATH;?>/css/borrow/jquery-2.0.3.min.js.下载"></script>
	<script type="text/javascript" src="<?php echo ADDON_PUBLIC_PATH;?>/css/borrow/jweixin-1.0.0.js.下载"></script>
...
<body>
    <div id="container" class="container body" style="min-height: 760px;">
       ...
       <!-- 
		...
		<div class="block_content_bg m_10"><p>大侠你好，关于<?php echo ($user["nickname"]); ?>向你借《<?php echo ($data["book"]); ?>》的请求您已经处理了</p></div>
					...
					<div class="form-item cf">
						 ...
						 <div class="controls">
						   <img src="<?php echo ADDON_PUBLIC_PATH;?>/css/borrow/1_12.gif">
							<input type="text" name="mes" id="fx_mes" placeholder="邮箱/手机号">
						 </div>
					</div>
