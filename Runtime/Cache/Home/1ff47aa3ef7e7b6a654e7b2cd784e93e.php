...
<div class="container">
  <div class="userHead">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li>
	   ...
	   <div class="fx_ownner"><span>分类： <?php echo ($data["kind"]); ?></span></div>
	   	  <!--<div class="fx_ownner"><span><a>取消推荐</a></span></div>
 <div class="fx_backMessage"><span>回复消息：<?php if($data["reply_info"] == null): ?>您没有没有回复<?php else: echo ($data["reply_info"]); endif; ?></span></div>-->
	   </div>
