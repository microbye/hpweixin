...
<div class="container">
  <div class="userHead">
   ...
   <!-- <a class="item" href="<?php echo U('bind_prize_info');?>"><span class="td title">资料编辑</span><em class="arrow">&nbsp;</em> </a>-->
	<a class="item" href="<?php echo U('adviseRecord');?>"><span class="td title">我的荐书</span><em class="arrow">&nbsp;</em> </a>	
	<a class="item" href="<?php echo U('lendRecord');?>"><span class="td title">借出记录</span><em class="arrow">&nbsp;</em> </a>
	<a class="item" href="<?php echo U('borrowRecord');?>"><span class="td title">借书记录</span><em class="arrow">&nbsp;</em> </a>
	<a class="item" href="index.php?s=/addon/WeiSite/BookInfo/feedback/userid/<?php echo ($info["uid"]); ?>/token/gh_b5826b7a409f"><span class="td title">意见反馈</span><em class="arrow">&nbsp;</em> </a>
