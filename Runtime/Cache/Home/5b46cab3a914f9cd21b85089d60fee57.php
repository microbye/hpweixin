      ...
      <div class="table-bar">
        <div class="fl">
			<div class="tools">
				...
				<button class="btn ajax-post confirm" target-form="ids" url="index.php?s=/addon/BookManage/AdviseBookManage/agree">通过</button>
				<button class="btn ajax-post confirm" target-form="ids" url="index.php?s=/addon/BookManage/AdviseBookManage/delByChoose">删 除</button>                
        ...
        <div class="search-form fr cf">
          <div class="sleft">
            ...
            <input type="text" name="nickname" class="search-input" value="<?php echo I('nickname');?>" placeholder="搜索功能暂时未开发，请不要使用">
      ...
      <div class="data-table">
        ...
        <div class=" table-striped">
          <table cellpadding="0" cellspacing="1">
            ...
            <thead>
              <tr>
                <th class="row-selected row-selected"> <input autocomplete="off" class="regular-checkbox check-all" type="checkbox" id="checkAll"><label for="checkAll"></label></th>                <th>书名</th><th>归属</th><th>作者</th><th>状态</th><th>推荐时间</th><th>操作</th>              </tr>
            </thead>
            
         <!-- 列表 -->
            <tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                  <td><input autocomplete="off" class="ids regular-checkbox" type="checkbox" value="<?php echo ($data["id"]); ?>" name="ids[]" id="check_<?php echo ($data["id"]); ?>"><label for="check_<?php echo ($data["id"]); ?>"></label></td>                  
				  <td><?php echo ($data["name"]); ?></td><td><?php echo ($data["nickname"]); ?></td><td><?php echo ($data["writer"]); ?></td><td><?php echo ($data["available"]); ?></td><td><?php echo ($data["create_time"]); ?></td><td><a target="_self" href="index.php?s=/addon/BookManage/AdviseBookManage/editbook/id/<?php echo ($data["id"]); ?>">编辑</a>
				  <a class="confirm" href="index.php?s=/addon/BookManage/AdviseBookManage/delBook/id/<?php echo ($data["id"]); ?>">删除</a></td>                
				  </tr><tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
          </table>
        </div>
      </div>
      </div>
      <div class="page"> <?php echo ($p); ?> </div>
    </section>
  </div>
