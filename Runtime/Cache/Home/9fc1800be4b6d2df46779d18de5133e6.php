      ...
      <div class="table-bar">
        <div class="fl">
			<div class="tools">
				...
				<button class="btn ajax-post confirm" target-form="ids" url="index.php?s=/addon/BorrowBook/BorrowBook/restoreByChoose">还原</button>                
          ...
          <table cellpadding="0" cellspacing="1">
            ...
            <thead>
              <tr>
				...
				<th>书名</th><th>归属</th><th>作者</th><th>种类</th><th>借出时间</th><th>操作</th>              </tr>
            </thead>
            
         <!-- 列表 -->
            <tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                  <td><input autocomplete="off" class="ids regular-checkbox" type="checkbox" value="<?php echo ($data["book_id"]); ?>" name="ids[]" id="check_<?php echo ($data["id"]); ?>"><label for="check_<?php echo ($data["id"]); ?>"></label></td>                  
				  ...
				  <a class="confirm" href="index.php?s=/addon/BorrowBook/BorrowBook/restoreBook/id/<?php echo ($data["book_id"]); ?>">还原</a></td>           
