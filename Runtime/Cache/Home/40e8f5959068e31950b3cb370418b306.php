...
<body>
    <div id="container" class="container body" style="min-height: 748px;">
		...
		<p style="word-wrap:break-word;">感谢您对此书的留言！</p>
		</div>
        ...
        <div class="block_content_bg m_10"> 
			...
			<form id="form" action="http://hpweixin.microbye.com/index.php?s=/addon/Forms/Wap/index.html" method="post" class="form-horizontal p_10">
					...
					<div class="form-item cf">
						 ...
						 <div class="controls">
						   <img src="<?php echo ADDON_PUBLIC_PATH;?>/css/form/1_12.gif">
							<textarea name="message" placeholder = "留言"  required="required" /></textarea>
						 </div>
					</div>
					...
					<div class="form-item cf">
						...
						<button class="home_btn submit-btn mb_10 mt_10" id="submit" type="button" target-form="form-horizontal">留言</button>			
					</div>
...
$('#submit').click(function(){
   ...
   $.Dialog.loading();
   $.ajax({
	   url:"index.php?s=/addon/WeiSite/BookInfo/messageDeal/token/gh_b5826b7a409f",
	   type:'post',
