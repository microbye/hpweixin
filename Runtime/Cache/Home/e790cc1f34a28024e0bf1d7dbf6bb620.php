...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
                <form id="form" action="index.php?s=/addon/BookManage/AdviseBookManage/updateBook/id/<?php echo ($book["id"]); ?>" method="post" class="form-horizontal form-center">
          
                    <div class="form-item cf toggle-name">
						<label class="item-label">书名                 
							<span class="check-tips">
							</span>
						</label>
						<div class="controls">
							<input type="text" class="text" name="name" value="<?php echo ($book["name"]); ?>">                    
						</div>
					</div>                
					
					<div class="form-item cf toggle-ownner">
					...
					<div class="form-item cf toggle-writer">
						<label class="item-label">作者                 
							<span class="check-tips">
							</span>
						</label>
						<div class="controls">
							<input type="text" class="text" name="writer" value="<?php echo ($book["writer"]); ?>">                    
						</div>
					</div>                
					
					<div class="form-item cf toggle-available">
						<label class="item-label">
                                        状态(1可借2不可借)                   
							<span class="check-tips">
                            </span>
						...
						<div class="controls">
							<select name = "available" value ="<?php echo ($book["available"]); ?>">
					...
					<div class="form-item cf toggle-description">
						<label class="item-label">
                                        描述                   
							<span class="check-tips">
                            </span>
						...
						<div class="controls">
							 ...
							 <input  type = text  height = "20"  name="description" value="<?php echo ($book["description"]); ?>">
