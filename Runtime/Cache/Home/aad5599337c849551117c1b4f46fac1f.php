...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="table-bar">
        <div class="fl">
			<div class="tools">
				<a class="btn" href="index.php?s=/addon/BookManage/BookManage/addbook">新 增</a>				
				<button class="btn ajax-post confirm" target-form="ids" url="index.php?s=/addon/BookManage/BookManage/delByChoose">删 除</button>                
        ...
        <div class=" table-striped">
         ...
         <!-- 列表 -->
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
				  ...
				  <td><?php echo ($data["name"]); ?></td><td><?php echo ($data["nickname"]); ?></td><td><?php echo ($data["writer"]); ?></td><td><?php echo ($data["available"]); ?></td><td><?php echo ($data["create_time"]); ?></td><td><a target="_self" href="index.php?s=/addon/BookManage/BookManage/editbook/id/<?php echo ($data["id"]); ?>">编辑</a>
				  <a class="confirm" href="index.php?s=/addon/BookManage/BookManage/delBook/id/<?php echo ($data["id"]); ?>">删除</a></td>                
