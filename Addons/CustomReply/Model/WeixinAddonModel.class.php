	...
	function reply($dataArr, $keywordArr = array()) {
		...
		if($data['Content']=='location'){
			...
			$articles [0] = array (
					...
					'PicUrl' => get_cover_url ( $info ['cover'] ),
					//'Url' => $this->_getNewsUrl ( $info, $param ) 
					'Url' =>'http://hpweixin.microbye.com/index.php?s=/addon/Forms/Wap/index/forms_id/1/publicid/1.html'
			);
			$content = "你好";
			//$res = $this->replyText ( $contetn );//$this->replyNews ( $articles );
		} else {
			// 增加积分
